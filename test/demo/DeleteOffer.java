...
public class DeleteOffer {
    ...
    public  static WebDriver deleteOffer() throws Exception
    {
        ...
        WebDriverWait wait = new WebDriverWait(driver,30);
          ...
          //Thread.sleep(2000);
          wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#users > li:nth-child(3) > a")));
          ...
          if(getCellData(38,0).equals("landlord"))
          {
              driver.findElement(By.cssSelector("#tt-table_wrapper > div:nth-child(2) > div > div.dataTables_scroll > div.dataTables_scrollFoot > div > table > tfoot > tr > td:nth-child(8) > input")).sendKeys("landlord");
             driver.findElement(By.cssSelector("#tt-table_wrapper > div:nth-child(2) > div > div.dataTables_scroll > div.dataTables_scrollFoot > div > table > tfoot > tr > td:nth-child(8) > input")).sendKeys(Keys.ENTER);
          }
             else
          {
              driver.findElement(By.cssSelector("#tt-table_wrapper > div:nth-child(2) > div > div.dataTables_scroll > div.dataTables_scrollFoot > div > table > tfoot > tr > td:nth-child(8) > input")).sendKeys(getCellData(38,0));
              driver.findElement(By.cssSelector("#tt-table_wrapper > div:nth-child(2) > div > div.dataTables_scroll > div.dataTables_scrollFoot > div > table > tfoot > tr > td:nth-child(8) > input")).sendKeys(Keys.ENTER);
          }
          Thread.sleep(10000);
