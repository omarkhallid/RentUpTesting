 ...
 * @author Farida Osama
 */
public class EditTanentProfile {

    public static WebDriver Edittanent() throws Exception {
        ...
        Thread.sleep(10000);
        driver.findElement(By.cssSelector("#tt-table_wrapper > div:nth-child(2) > div > div.dataTables_scroll > div.dataTables_scrollFoot > div > table > tfoot > tr > td:nth-child(7) > input")).sendKeys("magda");
        Thread.sleep(5000);
