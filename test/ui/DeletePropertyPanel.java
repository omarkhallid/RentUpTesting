 ...
 * @author Tarek Radwan
 */
public class DeletePropertyPanel extends javax.swing.JPanel {
private JLayeredPane layeredPane;
    /**
     * Creates new form DeleteProperty
     */
    public DeletePropertyPanel(JLayeredPane layeredPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DeletePropertyForm");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            setCellData("test1",32,0);
        }
        else
        {
            setCellData(jTextField1.getText().trim(),32,0);
        }
