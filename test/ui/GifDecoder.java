...
public class GifDecoder {
    ...
    // =no action; =leave in place; =restore to bg; =restore to prev
    ...
    /**
     * Gets the "Netscape" iteration count, if any. A count of  means
     * repeat indefinitiely.
     * 
     * @return iteration count if one was specified, else .
     */
     ...
     *            containing GIF file.
     * @return read status code ( = no errors)
     */
    ...
    protected void readLSD() {
        ...
        // packed fields
        int packed = read();
        gctFlag = (packed & 0x80) != 0; //  : global color table flag
        // - : color resolution
        //  : gct sort flag
        gctSize = 2 << (packed & 7); // - : gct size
